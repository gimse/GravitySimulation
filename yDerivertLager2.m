function [yDerivert] = yDerivertLager2(t,y,masser,g,minAvstand)
    ...
    for i=1:antallObjekter
        ...
        for m=1:antallObjekter
            if i~=m
                %Stopper objektene å faa unaturlig høy akselerasjon
                if norm(midYpos-y((m-1)*6+4:(m-1)*6+6))>=minAvstand
